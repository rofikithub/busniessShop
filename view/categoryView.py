...
class categoryView:
    def __init__(self, root):
        ...
        label_frame = tk.LabelFrame(frame, text="Category Details", padx=5, pady=5)
        ...
        category_name_label = tk.Label(name_frame, text="Name        ")
        ...
        save_frame = tk.Frame(update_frame, padx=40, pady=40)
        ...
        btn_frame = tk.Frame(update_frame, padx=40)
        ...
        back_frame = tk.Frame(update_frame, padx=40, pady=40)
