...
class SettingController:
    ...
    def getDeshboardBackground(self):
        ...
        self.backup_frame.configure(background=bg)
    ...
    def getSettingBackground(self):
        ...
        self.drive_frame.configure(background=bg)
        self.drive_LabelFrame.configure(background=bg)
        self.driver_frame.configure(background=bg)
        self.gdrive_frame.configure(background=bg)
        self.gdrive_label.configure(background=bg)
        self.driveg_frame.configure(background=bg)
        self.drivenot_frame.configure(background=bg)
        self.gdnote_label1.configure(background=bg)
        self.gdnote_label2.configure(background=bg)
        self.gdnote_label3.configure(background=bg)
        self.dbfile_frame.configure(background=bg)
        self.dbfile_LabelFrame.configure(background=bg)
        self.database_frame.configure(background=bg)
        self.dbf_frame.configure(background=bg)
        self.dbf_label.configure(background=bg)
        self.bdfile_frame.configure(background=bg)
        self.dbnote_frame.configure(background=bg)
        self.dbnote_label1.configure(background=bg)
        self.dbnote_label2.configure(background=bg)
        self.dbnote_label3.configure(background=bg)
        self.sjson_frame.configure(background=bg)
        self.sjson_LabelFrame.configure(background=bg)
        self.system_frame.configure(background=bg)
        self.sjfile_frame.configure(background=bg)
        self.sjfile_label.configure(background=bg)
        self.sjsonf_frame.configure(background=bg)
        self.sysnot_frame.configure(background=bg)
        self.sysnote_label1.configure(background=bg)
        self.sysnote_label2.configure(background=bg)
        self.sysnote_label3.configure(background=bg)
        ...
        if bg=='Black' or bg=='Green' or bg=="Red":
            ...
            self.drive_LabelFrame.configure(fg='White')
            self.gdrive_label.configure(fg='White')
            self.gdnote_label1.configure(fg='White')
            self.gdnote_label2.configure(fg='White')
            self.gdnote_label3.configure(fg='White')
            self.dbfile_LabelFrame.configure(fg='White')
            self.dbf_label.configure(fg='White')
            self.dbnote_label1.configure(fg='White')
            self.dbnote_label2.configure(fg='White')
            self.dbnote_label3.configure(fg='White')
            self.sjson_LabelFrame.configure(fg='White')
            self.sjfile_label.configure(fg='White')
            self.sysnote_label1.configure(fg='White')
            self.sysnote_label2.configure(fg='White')
            self.sysnote_label3.configure(fg='White')
        else:
            ...
            self.drive_LabelFrame.configure(fg='Black')
            self.gdrive_label.configure(fg='Black')
            self.gdnote_label1.configure(fg='Black')
            self.gdnote_label2.configure(fg='Black')
            self.gdnote_label3.configure(fg='Black')
            self.dbfile_LabelFrame.configure(fg='Black')
            self.dbf_label.configure(fg='Black')
            self.dbnote_label1.configure(fg='Black')
            self.dbnote_label2.configure(fg='Black')
            self.dbnote_label3.configure(fg='Black')
            self.sjson_LabelFrame.configure(fg='Black')
            self.sjfile_label.configure(fg='Black')
            self.sysnote_label1.configure(fg='Black')
            self.sysnote_label2.configure(fg='Black')
            self.sysnote_label3.configure(fg='Black')
